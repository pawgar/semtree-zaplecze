...
<ul class="nav nav-tabs mb-3" role="tablist">
    <li class="nav-item">
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#orderSingleTab" type="button">
            <i class="bi bi-file-earmark-text"></i> Pojedynczy artykuł
        </button>
    </li>
    <li class="nav-item">
...
<div class="card mb-3">
    <div class="card-body">
        <h6 class="card-title"><i class="bi bi-1-circle"></i> Wybierz stronę zapleczową</h6>
...
<div class="card mb-3" id="orderFormCard" style="display:none">
    <div class="card-body">
        <h6 class="card-title"><i class="bi bi-2-circle"></i> Parametry artykułu</h6>
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label class="form-label">Słowa kluczowe pomocnicze <span class="text-muted">(opcjonalnie)</span></label>
            ...
            <div class="col-12">
                <button class="btn btn-primary" onclick="orderGenerate()" id="orderGenerateBtn">
                    <i class="bi bi-stars"></i> Generuj artykuł
                </button>
            </div>
        </div>
    </div>
...
<div class="card mb-3" id="orderEditCard" style="display:none">
    <div class="card-body">
        <h6 class="card-title"><i class="bi bi-4-circle"></i> Edycja artykułu</h6>
        ...
        <div class="row mb-3">
            <div class="col-md-9">
                ...
                <div class="btn-toolbar border rounded-top bg-light p-1 gap-1" id="orderEditorToolbar">
                    <div class="btn-group btn-group-sm">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="editorCmd('underline')" title="Podkreślenie (Ctrl+U)"><i class="bi bi-type-underline"></i></button>
                        <button type="button" class="btn btn-outline-secondary" onclick="editorCmd('strikeThrough')" title="Przekreślenie"><i class="bi bi-type-strikethrough"></i></button>
                    </div>
                    <div class="btn-group btn-group-sm">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="editorRemoveLink()" title="Usuń link"><i class="bi bi-link-45deg text-danger"></i><i class="bi bi-x" style="margin-left:-4px"></i></button>
                    </div>
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn btn-outline-secondary" onclick="editorCmd('removeFormat')" title="Usuń formatowanie"><i class="bi bi-eraser"></i></button>
            ...
            <div class="col-md-3">
                ...
                <button class="btn btn-outline-info btn-sm mt-2 w-100" onclick="orderRegenerateFeatured()">
                    <i class="bi bi-arrow-clockwise"></i> Regeneruj grafikę
                </button>
            </div>
        </div>
        ...
        <button class="btn btn-success btn-lg" onclick="orderPublish()" id="orderPublishBtn">
            <i class="bi bi-send"></i> Opublikuj artykuł
        </button>
    </div>
</div>
    ...
    <div class="card-body">
        ...
        <div class="d-flex gap-2 mb-2 align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center gap-1 ms-3">
                <label class="small text-muted text-nowrap">Język domyślny:</label>
