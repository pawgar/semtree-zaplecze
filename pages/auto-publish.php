            ...
            <table class="table table-vcenter card-table table-hover table-sm mb-0" id="apSitesTable" style="table-layout:fixed">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width:55px" title="Indeksacja linków (Rapid URL Indexer)"><label class="form-check form-check-inline mb-0"><input type="checkbox" class="form-check-input" title="Zaznacz/odznacz wszystkie" onchange="toggleAllApCheckbox('ap-speed-links', this.checked)"><span class="form-check-label small">Idx</span></label></th>
