    ...
    <div class="card-body">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <button class="btn btn-primary btn-sm" onclick="loadWpData()">
                <i class="ti ti-refresh"></i> Odśwież dane WP
            </button>
...
<div class="card mb-3 d-none" id="docxLoadCard">
    <div class="card-body">
        <h6 class="card-title"><i class="ti ti-circle-number-3"></i> Wgraj pliki DOCX</h6>
        <p class="text-secondary small mb-2">Wybierz pliki DOCX odpowiadające planom z XLSX — system dopasuje po nazwie pliku.</p>
        <div class="d-flex gap-2 align-items-center">
            <button class="btn btn-outline-primary btn-sm" onclick="document.getElementById('importDocxFiles').click()">
                <i class="ti ti-file-word"></i> Wybierz pliki DOCX (wiele)
            </button>
            <input type="file" id="importDocxFiles" accept=".docx" multiple style="display:none" onchange="uploadImportDocxFiles(this)">
            <span id="docxMatchStatus" class="text-secondary small"></span>
        </div>
...
<div class="card mb-3 d-none" id="importArticlesCard">
    <div class="card-body">
        <h6 class="card-title"><i class="ti ti-circle-number-4"></i> Lista artykułów</h6>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm" id="articlesTable">
                ...
                <tbody id="articlesBody">
                    <tr><td colspan="8" class="text-center text-secondary">Wgraj XLSX aby załadować artykuły.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
...
<div class="card mb-3 d-none" id="importPublishCard">
    <div class="card-body">
        <h6 class="card-title"><i class="ti ti-circle-number-5"></i> Publikuj</h6>
